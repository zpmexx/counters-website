...
function App() {
  ...
  const [selectedDateRange, setSelectedDateRange] = useState({ rangeStart: rangeStart, rangeEnd: rangeEnd });
  ...
  <div className="App">
    ...
    <div className="flex m-5 mt-8">
      ...
      <ShopChart selectedDateRange={selectedDateRange} chartData={chartData} shopId={selectedShop} />
    </div>
  </div>
  );
}
